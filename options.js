const SOURCES = [
  { key: "virustotal", name: "VirusTotal", color: "vt", tag: "needs-key", desc: "API · key required" },
  { key: "abuseipdb",  name: "AbuseIPDB", color: "aip", tag: "needs-key", desc: "API · key required · IP only" },
  { key: "urlscan",    name: "URLScan.io", color: "us", tag: "free", desc: "API · free, no key" },
  { key: "otx",        name: "AlienVault OTX", color: "otx", tag: "free", desc: "API · free, no key" },
  { key: "threatfox",  name: "ThreatFox", color: "tf", tag: "needs-key", desc: "API · abuse.ch Auth-Key" },
  { key: "urlhaus",    name: "URLHaus", color: "uh", tag: "needs-key", desc: "API · abuse.ch Auth-Key" },

  { key: "talos",       name: "Cisco Talos", color: "talos", tag: "manual", desc: "manual lookup link", badge: "manual" },
  { key: "ipvoid",      name: "IPVoid / URLVoid", color: "ipvoid", tag: "manual", desc: "manual lookup link", badge: "manual" },
  { key: "mxtool",      name: "MXToolBox", color: "mxtool", tag: "manual", desc: "manual lookup link · blacklists/MX", badge: "manual" },
  { key: "crowdsec",    name: "CrowdSec", color: "crowdsec", tag: "manual", desc: "manual lookup link · CTI", badge: "manual" },
  { key: "rstcloud",    name: "RST Cloud", color: "rstcloud", tag: "manual", desc: "manual lookup link · TI", badge: "manual" },
  { key: "threatbook",  name: "ThreatBook", color: "threatbook", tag: "manual", desc: "manual lookup link · CTI", badge: "manual" },
  { key: "xforce",      name: "X-Force Exchange", color: "xforce", tag: "manual", desc: "manual lookup link · IBM", badge: "manual" },
  { key: "scamalytics", name: "Scamalytics", color: "scamalytics", tag: "manual", desc: "manual lookup link · IP only", badge: "manual" },
];
...
const enabled = new Set(SOURCES.map(s => s.key));
